...
(
				  SELECT 1, 'Liliana', 'Vess', NULL, GETDATE(), 0
			UNION SELECT 2, 'Elspeth', 'Tirel', NULL, GETDATE(), 0
			UNION SELECT 3, 'Chandra', 'Nalaar', NULL, GETDATE(), 0
			UNION SELECT 4, 'Nissa', 'Revane', NULL, GETDATE(), 0
)
MERGE INTO Person
